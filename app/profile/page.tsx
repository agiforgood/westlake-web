...
export default function ProfilePage() {
  ...
  const sidebarItems = [
    { id: "manual", name: "说明书", icon: User },
    { id: "basic-info", name: "个人基础信息", icon: User },
    { id: "skills", name: "专业能力与贡献范围", icon: Briefcase },
    { id: "values", name: "价值观与期望连接", icon: Heart },
    { id: "contact", name: "联系信息和可享与时间", icon: Clock },
  ]
            ...
            <div className="max-w-4xl">
              ...
              {activeSection === "skills" && (
                <Card className={theme === "dark" ? "bg-slate-800 border-slate-700" : "bg-white border-gray-200"}>
                  ...
                  <CardContent>
                    <p className={theme === "dark" ? "text-slate-400" : "text-gray-600"}>
                      这里可以详细描述您的专业技能、工作经验和能够为社区贡献的专业能力。
                    </p>
                  </CardContent>
                </Card>
              )}
